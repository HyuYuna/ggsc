      ...
      <div class="content-area">
        <div class="article-area">
          <div class="board_box article-header" >
            <div class="txt_area">   
              <!-- 제목 -->
              <strong class="tit"><c:out value="${centerNews.title }" escapeXml="false" /> </strong>
              <!-- 제목 //-->
              <!-- 글등록정보 -->
              <div class="user_area">
                <span class="nick">
                  <span class="ellip"><span class="ellip"><c:out value="${centerNews.writer }" /></span></span>
                  <span class="time"><c:out value="${centerNews.dbInsTm }" /></span>
                  <span class="no"><c:out value="${centerNews.num }" /></span>
                </span>
              </div>
              <!-- 글등록정보 //-->
            </div>
          ...
          <div class="article-body">
            <div class="article">
            <textarea id="rcontent" name="content" readonly="readonly" ><c:out value="${centerNews.cntn }" escapeXml="false" /></textarea>
            </div>
          </div><!-- .article-body /-->
            
        </div><!-- .article-list-area /-->
        <div class="btn-wrap line bt bb pt10 pb10 mt20 text-center">
          <button type="button" class="btn btn-default btn-lg fl" onclick="javascript:fn_movePage('<c:out value="${centerNews.num}"/>','Y');"><i class="fa fa-caret-left mr5"></i>이전글</button>
          ...
          <button type="button" class="btn btn-default btn-lg fr" onclick="javascript:fn_movePage('<c:out value="${centerNews.num}"/>','N');">다음글<i class="fa fa-caret-right ml5"></i></button>
        </div>
      </div><!-- .content-area /-->
