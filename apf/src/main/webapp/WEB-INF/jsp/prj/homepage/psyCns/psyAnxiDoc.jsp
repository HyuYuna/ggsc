	           ...
	           <table class="table table-condensed">
	               ...
	               <tbody>
	                   ...
	                   <tr class="bBottom2">
	                       ...
	                       <td><input type="radio" id="no51" name="no5" value="4" /></td>
	                       <td><input type="radio" id="no52" name="no5" value="3" /></td>
	                       <td><input type="radio" id="no53" name="no5" value="2" /></td>
	                       <td class="bRight-none"><input type="radio" id="no54" name="no5" value="1" /></td>
	                   </tr>
	                   <tr class="bBottom2">
	                   ...
	                   <tr class="bBottom2">
	                       ...
	                       <td><input type="radio" id="no91" name="no9" value="4" /></td>
	                       <td><input type="radio" id="no92" name="no9" value="3" /></td>
	                       <td><input type="radio" id="no93" name="no9" value="2" /></td>
	                       <td class="bRight-none"><input type="radio" id="no94" name="no9" value="1" /></td>
	                   </tr>
	                   <tr class="bBottom">
	                   ...
	                   <tr class="bBottom2">
	                       ...
	                       <td><input type="radio" id="no131" name="no13" value="4" /></td>
	                       <td><input type="radio" id="no132" name="no13" value="3" /></td>
	                       <td><input type="radio" id="no133" name="no13" value="2" /></td>
	                       <td class="bRight-none"><input type="radio" id="no134" name="no13" value="1" /></td>
	                   </tr>
	                   <tr class="bBottom2">
	                   ...
	                   <tr class="bBottom2">
	                       ...
	                       <td><input type="radio" id="no171" name="no17" value="4" /></td>
	                       <td><input type="radio" id="no172" name="no17" value="3" /></td>
	                       <td><input type="radio" id="no173" name="no17" value="2" /></td>
	                       <td class="bRight-none"><input type="radio" id="no174" name="no17" value="1" /></td>
	                   </tr>
	                   <tr class="bBottom2">
	                   ...
	                   <tr class="bBottom2">
	                       ...
	                       <td><input type="radio" id="no191" name="no19" value="4" /></td>
	                       <td><input type="radio" id="no192" name="no19" value="3" /></td>
	                       <td><input type="radio" id="no193" name="no19" value="2" /></td>
	                       <td class="bRight-none"><input type="radio" id="no194" name="no19" value="1" /></td>
	                   </tr>
	                   <tr class="bBottom">
