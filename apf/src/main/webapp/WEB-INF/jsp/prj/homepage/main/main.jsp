		...
		function listCenter(idx) {
			...
			case 1: //가평
				...
				html = '<table style="border:1px;">' + '<colgroup>'
						...
						+ '<td class="tel">031-581-6063</td>' + '</tr>'
						+ '</table>'
				break;
			case 2: // 고양
				$("#nowMap").text('고양')
			...
			case 3: // 과천 
				...
				html = '<table style="border:1px;">' + '<colgroup>'
						...
						+ '<td class="tel">02-502-8500</td>' + '</tr>'
						+ '</table>'
				break;
			...
			case 4:
				...
				html = '<table style="border:1px;">' + '<colgroup>'
						...
						+ '<td class="tel">02-2625-9300</td>' + '</tr>'
						+ '</table>'
				break;
			...
			case 5:
				...
				html = '<table style="border:1px;">' + '<colgroup>'
						...
						+ '<td class="tel">031-766-9129</td>' + '</tr>'
						+ '</table>'
				break;
			...
			case 6:
				...
				html = '<table style="border:1px;">' + '<colgroup>'
						...
						+ '<td class="tel">031-556-8100</td>' + '</tr>'
						+ '</table>'
				break;
			...
			case 7:
				...
				html = '<table style="border:1px;">' + '<colgroup>'
						...
						+ '<td class="tel">031-392-5755</td>' + '</tr>'
						+ '</table>'
				break;
			...
			case 9:
				...
				html = '<table style="border:1px;">' + '<colgroup>'
						...
						+ '<td class="tel">031-573-6598</td>' + '</tr>'
						...
						+ '<td class="tel">031-590-3000</td>' + '</tr>'
						+ '</table>'
				break;
			...
			case 10:
				...
				html = '<table style="border:1px;">' + '<colgroup>'
						...
						+ '<td class="tel">031-857-9918</td>' + '</tr>'
						+ '</tr>' + '</table>'
				break;
			...
			case 14:
				...
				html = '<table style="border:1px;">' + '<colgroup>'
						...
						+ '<td class="tel">031-404-3122</td>' + '</tr>'
						+ '</table>'
				break;
			...
			case 16:
				...
				html = '<table style="border:1px;">' + '<colgroup>'
						...
						+ '<td class="tel">031-674-0794</td>' + '</tr>'
						+ '</table>'
				break;
			...
			case 17:
				...
				html = '<table style="border:1px;">'
						...
						+ '<td class="tel">031-455-0551</td>' + '</tr>'
						+ '</table>'
				break;
			...
			case 18:
				...
				html = '<table style="border:1px;">' + '<colgroup>'
						...
						+ '<td class="tel">031-859-9081</td>' + '</tr>'
						+ '</table>'
				break;
			...
			case 19:
				...
				html = '<table style="border:1px;">' + '<colgroup>'
						...
						+ '<td class="tel">031-774-9751</td>' + '</tr>'
						+ '</table>'
				break;
			...
			case 20:
				...
				html = '<table style="border:1px;">' + '<colgroup>'
						...
						+ '<td class="tel"> 031-881-0050</td>' + '</tr>'
						+ '</table>'
				break;
			...
			case 21:
				...
				html = '<table style="border:1px;">' + '<colgroup>'
						...
						+ '<td class="tel">031-834-6080</td>' + '</tr>'
						+ '</table>'
				break;
			...
			case 22:
				...
				html = '<table style="border:1px;">' + '<colgroup>'
						...
						+ '<td class="tel">031-290-8530</td>' + '</tr>'
						+ '</table>'
				break;
			...
			case 26:
				...
				html = '<table style="border:1px;">' + '<colgroup>'
						...
						+ '<td class="tel">031-636-0190</td>' + '</tr>'
						+ '</table>'
				break;
			...
			case 27:
				...
				html = '<table style="border:1px;">' + '<colgroup>'
						...
						+ '<td class="tel">031-943-0730</td>' + '</tr>'
						+ '</table>'
				break;
			...
			case 29:
				...
				html = '<table style="border:1px;">' + '<colgroup>'
						...
						+ '<td class="tel">031-8083-7777</td>' + '</tr>'
						+ '</table>'
				break;
			...
			case 30:
				...
				html = '<table style="border:1px;">' + '<colgroup>'
						...
						+ '<td class="tel">031-794-9368</td>' + '</tr>'
						+ '</table>'
				break;
