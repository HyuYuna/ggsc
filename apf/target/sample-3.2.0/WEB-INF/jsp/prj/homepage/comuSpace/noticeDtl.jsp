        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu"  role="menu">
                <li class="dropdown-item active"><a href="/gnoincoun/noticeList.do">공지사항<i class="fa fa-caret-right"></i></a></li>
    ...
    <div class="container content-wrapper">
      ...
      <div class="content-area">
        ...
        <div class="btn-wrap line bt bb pt10 pb10 mt20 text-center">
          ...
          <button type="button" class="btn btn-normal btn-lg" onclick="location.href='/gnoincoun/noticeList.do'"><i class="fa fa-align-justify mr5"></i>목록</button>
