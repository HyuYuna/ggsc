...
public class ComfCnsVO {
	...
	public String toString() {
		return "ComfCnsVO [num=" + num + ", cnsGb=" + cnsGb + ", zoneGb=" + zoneGb + ", cnsReqGb=" + cnsReqGb
				+ ", centerGb=" + centerGb + ", cnsleId=" + cnsleId + ", cnsleNm=" + cnsleNm + ", userId=" + userId
				+ ", gender=" + gender + ", birth=" + birth + ", email=" + email + ", tel=" + tel + ", phone=" + phone
				+ ", address=" + address + ", cnsHistYn=" + cnsHistYn + ", cnsCntn=" + cnsCntn + ", dbInsTm=" + dbInsTm
				+ ", file=" + file + ", fileNm=" + fileNm + ", sysFileNm=" + sysFileNm + ", filePath=" + filePath
				+ ", fileSize=" + fileSize + ", fileDesc=" + fileDesc + ", cnsrGb=" + cnsrGb + ", cnsDt=" + cnsDt
				+ ", cnsDtStdHour=" + cnsDtStdHour + ", cnsDtStdMin=" + cnsDtStdMin + ", cnsDtEndHour=" + cnsDtEndHour
				+ ", cnsDtEndMin=" + cnsDtEndMin + ", cnsDtTotMin=" + cnsDtTotMin + ", cnsDtl=" + cnsDtl + ", olderRel="
				+ olderRel + ", edu=" + edu + ", relg=" + relg + ", livgForm=" + livgForm + ", houseForm=" + houseForm
				+ ", merrStat=" + merrStat + ", liveForm=" + liveForm + ", majorProb=" + majorProb + ", psyExam="
				+ psyExam + ", localGb=" + localGb + ", majorApplCd=" + majorApplCd + "]";
	}
