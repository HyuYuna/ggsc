...
@Service("mobileFreeBbsService")
public class MobileFreeBbsServiceImpl extends EgovAbstractServiceImpl implements MobileFreeBbsService {

	private static final Logger LOGGER = LoggerFactory.getLogger(MobileFreeBbsServiceImpl.class);
	
	/** SampleDAO */
	// TODO ibatis 사용
	@Resource(name = "mobileFreeBbsMapper")
	private MobileFreeBbsMapper mobileFreeBbsMapper;
	// TODO mybatis 사용
	...
	public List<EgovMap> getFreeBbsListA(BbsVO vo) {
		return mobileFreeBbsMapper.getFreeBbsListA(vo);
	}
	
	// 게시판 목록 최신 5개(알려드려요)
	@Override	
	public List<EgovMap> getFreeBbsListALimit(BbsVO vo) {
		return mobileFreeBbsMapper.getFreeBbsListALimit(vo);	
	}
	
	// 게시판 목록(자유게시판)
	public List<EgovMap> getFreeBbsListB(BbsVO vo) {
		return mobileFreeBbsMapper.getFreeBbsListB(vo);
	}
		
	// 게시판 상세보기(알려드려요)
	@Override
	public EgovMap getFreeBbsADtl(BbsVO vo) {
		return mobileFreeBbsMapper.getFreeBbsADtl(vo);
	}
	
	// 게시판 상세보기(자유게시판)
	@Override
	public EgovMap getFreeBbsBDtl(BbsVO vo) {
		return mobileFreeBbsMapper.getFreeBbsBDtl(vo);
	}
	
	// 게시판 등록(자유게시판)
	@Override
	public void insertFreeBbsBReg(BbsVO vo) throws Exception {
		mobileFreeBbsMapper.insertFreeBbsBReg(vo);
