...
@Service("mobileCareLibraryService")
public class MobileCareLibraryServiceImpl extends EgovAbstractServiceImpl implements MobileCareLibraryService {

	private static final Logger LOGGER = LoggerFactory.getLogger(MobileCareLibraryServiceImpl.class);
	
	/** SampleDAO */
	// TODO ibatis 사용
	@Resource(name = "mobileCareLibraryMapper")
	private MobileCareLibraryMapper mobileCareLibraryMapper;
	// TODO mybatis 사용
	...
	public List<EgovMap> getCrLibraryList(CrLibraryVO vo) {
		return mobileCareLibraryMapper.getCrLibraryList(vo);
	}
	
	// 마음돌봄 자료실 상세보기
	public EgovMap getCareLibraryDtl(CrLibraryVO vo) {
		return mobileCareLibraryMapper.getCareLibraryDtl(vo);
	}
	
	// 마음돌봄 자료실 총갯수
	public int getCareLibraryTotal() {
		return mobileCareLibraryMapper.getCareLibraryTotal();
	}
	
	// 파일 업로드
	/*public static EgovMap fileUpload(MultipartFile file, CrLibraryVO vo){
		...
		try {
			...
			System.out.println("fileUpload mobile");
			return null;
		}
	}*/
