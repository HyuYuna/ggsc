...
public class MypageServiceImpl extends EgovAbstractServiceImpl implements MypageService {
	...
	/**  의료요양지시서 - 작성자 정보조회회  */
	@Override
	public List<?> mypageList4(MypageDefaultVO searchVO){
		try {
	 ...
	 */
	@Override
	public String insertMypage(MypageVO vo) throws Exception {
	 ...
	 */
	@Override
	public List<?> schUploadRptMypage(MypageVO vo) throws Exception {
