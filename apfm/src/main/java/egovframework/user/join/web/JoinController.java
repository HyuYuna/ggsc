...
public class JoinController {
	...
	public String joinerror(@ModelAttribute("searchVO") JoinDefaultVO searchVO, ModelMap model){
	...
	public String joinIdCheck(JoinVO joinVO, Model model, HttpServletRequest req) throws Exception {
