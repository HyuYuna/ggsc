            ...
            <table class="table table-condensed">
                ...
                <tbody>
                    <tr>
                        ...
                        <th scope="col">나이</th>
                        <td>
                            <input type="text" id="age" name="age" style="width: 30px;" oninput="this.value = this.value.replace(/[^0-9]/g, '');" readonly="readonly" value="${map.age }">
                        </td>
                        <th scope="col">연락처</th>
                        <td>
