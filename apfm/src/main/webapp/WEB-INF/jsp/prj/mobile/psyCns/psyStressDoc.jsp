	  ...
	  function fn_reg() {
		  ...
		  if(sumCnt != "") {
			  if(confirm("자가진단을 다시 하시겠습니까?")){
				  location.href="/mgnoincoun/psyStressDoc.do";
				  return false;
			  }
			  return false;
		  }
		  if(confirm("자가진단 작성을 완료하셨습니까?")){
			...
			$.ajax({
				type : "POST",
				url : "/mgnoincoun/psyStressDocRegAjax.do",
				data : param,
				dataType : "json",
				success : function(json) {
  ...
  <body>
    ...
    <div class="container content-wrapper">
      <div class="page-header">
        <h1 class="title" style="text-align: center;">스트레스척도</h1>
        <ol class="breadcrumb">
            ...
            <table class="table table-condensed">
                ...
                <tbody>
                    <tr>
                      ...
                      <th scope="col">검사일</th>
                      <td>
                          <input type="text" id="writeDt" name="writeDt" style="width: 100px;" readonly="readonly" >
                      </td>
                    </tr>
                </tbody>
            </table>
