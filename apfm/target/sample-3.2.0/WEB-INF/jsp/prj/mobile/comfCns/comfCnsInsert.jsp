          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="/mgnoincoun/comfCnsInsert.do">맘편한 상담<i class="fa fa-caret-right"></i></a></li>
            ...
            <table  class="table table-condensed line bb">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div>
                        <input type="text" id="birth" name="birth" class="form-control" maxlength="8" placeholder="ex)20201025" value="${map.birthDt }" oninput="this.value = this.value.replace(/[^0-9]/g, ''); $('tel').val(this.value);">
                        <!-- <span class="input-group-btn">
                ...
                <tr>
                  ...
                  <td><input type="text" class="form-control" id="phone" name="phone" value="${map.mobile }" /></td>
                </tr>
                <tr>
                  ...
                  <td>
                   ...
                   <input name="address" id="address" type="text" maxlength="50" class="form-control" value="${map.addr }" />
                  </td>
                </tr>
                <!-- <tr>
