...
<html lang="ko">
  ...
  <script>
	function fn_agree_check() {
  		...
  		location.href = "/mgnoincoun/join.do";
  	}
  </script>
  <body>
    <!-- 헤더 ================================================== -->
    ...
    <div class="container content-wrapper">
      <div class="page-header">
        <h1 class="title"><i class="fa fa-comments-o"></i>약관동의</h1>
        <ol class="breadcrumb">
      ...
      <h2 class="title" style="display: inline-block;">이용약관</h2><span>에 대한 안내입니다.</span>
      <div class="login-content">
      <h3>이용약관</h3>
		<form class="form-wrap" id="frm" name="frm" method="post">
          <div class="form-group line bt bb pt15 pb10" style="height: 100px; overflow: hidden; overflow-y: auto; white-space: pre">
제 1 조 (목적)
...
경찰청 사이버테러대응센터 (www.ctrc.go.kr/02-392-0330)         
          ...
          <div class="btn-wrap line bt pt20">
            ...
            <button type="button" class="btn btn-primary btn-lg w50p" onclick="location.href='/mgnoincoun/login.do'" style="color: #fff; background-color: #78849E; border-color: #78849E; float: left;">취소</button>
          </div>
          </div>
         
          <!-- <div class="btn-wrap line bt pt20">
            <button type="button" class="btn btn-primary btn-lg w100p" onClick="javascript:fn_reg();">회원가입</button>
            <button type="button" class="btn btn-primary btn-lg w100p" onclick="location.href=/mgnoincounlogin.do'" style="color: #fff; background-color: #78849E; border-color: #78849E;">로그인</button>
          </div> -->
        </form>
	  </div>
