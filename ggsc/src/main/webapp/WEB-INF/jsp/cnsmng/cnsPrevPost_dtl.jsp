		        ...
		        <div class="doc-box mt20" id="cnsPrev">
		            ...
		            <div class="con-info">
		                <div class="mt40">
		                    ...
		                    <div class="noto500 mt40">3. 주호소 문제 검사 : 
		                    	<input type="text" class="inp14 txt-right" id="prevMajorApplCd" name="prevMajorApplCd" value="${detail.majorApplCd}" oninput="this.value = this.value.replace(/[^0-9]/, '');" maxlength="2">&emsp;&emsp;&emsp;&emsp;
		            ...
		            <div class="con-info">
		                ...
		                <div class="mt40">
		                    ...
		                    <div class="noto500 mt40">3. 주호소 문제 검사 : 
		                    	<input type="text" class="inp14 w21 txt-right" id="postMajorApplCd" name="postMajorApplCd" value="${detail.majorApplCd}" oninput="this.value = this.value.replace(/[^0-9]/, '');" maxlength="2">&emsp;&emsp;&emsp;&emsp;
