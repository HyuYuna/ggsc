...
<script type="text/javascript">
	...
	function fn_reg(mnuCd,param){
		...
		if(param == "S") {
			...
			if(confirm("등록 하시겠습니까?")){
				$("#num").val(0);
				document.frm.action = "/gnoincoundb/superVisionReg_test.do?mnuCd=" + mnuCd +"&save=" + param;
		       	document.frm.submit();
			}			
		} else if(param == "U") {
			if(titleC.length == 0) {
			...
			if(confirm("답변을 등록 하시겠습니까?")){
				document.frm2.action = "/gnoincoundb/superVisionReg_test.do?mnuCd=" + mnuCd +"&save=" + param;
	...
	function fn_list() {
		var mnuCd = $("#mnuCd").val();
		document.location.href = "/gnoincoundb/superVisionList_test.do?mnuCd=" + mnuCd;
	}
