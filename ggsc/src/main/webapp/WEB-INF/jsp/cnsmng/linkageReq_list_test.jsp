...
<script type="text/javascript">
	...
	function fn_reg(mnuCd){
		document.location.href = "/gnoincoundb/linkageReqDtl_test.do?mnuCd=" + mnuCd;
	}
	...
	function fn_detail(num,linkReqGb){
		var mnuCd = $("#mnuCd").val();
		document.location.href = "/gnoincoundb/linkageReqDtl_test.do?num=" + num +"&linkReqGb=" + linkReqGb + "&mnuCd=" + mnuCd;
	}
