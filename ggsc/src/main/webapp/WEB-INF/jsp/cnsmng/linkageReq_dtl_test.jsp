...
<script type="text/javascript">
	...
	function fn_list(mnuCd){
		document.location.href = "/gnoincoundb/linkageReqList_test.do?mnuCd=" + mnuCd;
	...
	function findUserPopup(){
		...
		var url = "/gnoincoundb/findUserPopup_test.do?userNm=" + userNm+"&cnsTargetGb=Y";
		var name = "회원 찾기";
					...
					<tbody>
						<tr>
							...
							<td>
								...
								<!--  내부연계의뢰서인 경우 데이터가 안 보이게 세팅함 현 상황에서 페이지에 바로 접속하는 경우는 외부연계구분 select가 안 보이는 상태인 것  -->
