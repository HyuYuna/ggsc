...
<script type="text/javascript">
	...
	function fn_reg() {
		...
		*/
		...
		if($('input:radio[name="radio1Yn"]').is(':checked')==false){
			alert("정보 수집에 대한 동의여부를 선택해주세요.");
			return;
		}
		if($('input:radio[name="radio2Yn"]').is(':checked')==false){
			alert("동의 여부를 선택하세요");
			return;
		}
...
<section id="content">
	...
	<h2 class="h2-title"><i class="fa fa-check-square"></i>radiohead 등록</h2>	
		<div class="box-style1 x-scroll-auto" >
			<div>
				<ul class="tabs">
					<li style="border-style: solid; border-bottom-style:none; border-width: thin;" onclick="fn_goLink(1);">oasis</li>
					<li style="border-style: solid; border-bottom-style:none; border-width: thin; background-color: gray;">radiohead</li>
			...
			<div style="border-style: solid; border-width: thin; width:100%; height: auto; padding: 10px 10px 10px 10px;">
				<form id="frm" name="frm" method="post" enctype="multipart/form-data">
					...
					<input type="hidden" id="bandCd" name="bandCd" value="3" />
					<input type="hidden" id="docGb" name="docGb" value="1" />
					<input type="hidden" id="radioYn" name="radioYn" value="Y" />
				...
				<div style="border-style: solid; border-width: thin; width:700px; height: auto; padding: 30px 20px 20px 20px; margin: 10px 10px 10px 450px;">
					...
					<font style="font-size: small;"> 경기도노인종합상담센터와 OOO 노인상담센터는 개인정보 보호법에 명기된 관련 법률상의 개인정보처리자가 준수하여야 할 개인정보보호 
					...
					<div style="border-bottom-style: dotted; border-top-style: dotted; border-width: thin; background-color: #D5D5D5; position: relative; left: -20px; width: 698px; text-align: center;">
						<font style="font-size: medium; font-weight: bold;"> 위 정보 수집에 동의하십니까? </font><input type="radio" id="radio1Y" name="radio1Yn" value="Y" style="width: 15px; height: 15px;"/><label style="font-size: medium;" for="radio1Y"> 동의함</label>
						<input type="radio" id="radio1N" name="radio1Yn" value="N" style="width: 15px; height: 15px;"/><label style="font-size: medium;" for="radio1N"> 동의하지 않음(작성종료)</label>
					</div><br>
					...
					<div style="border-bottom-style: dotted; border-top-style: dotted; border-width: thin; background-color: #D5D5D5; position: relative; left: -20px; width: 698px; text-align: center;">
						<font style="font-size: medium; font-weight: bold;"> 위 민감 정보 수집에 동의하십니까? </font><input type="radio" id="radio2Y" name="radio2Yn" value="Y" style="width: 15px; height: 15px;"/><label style="font-size: medium;" for="radio2Y"> 동의함</label>
						<input type="radio" id="radio2N" name="radio2Yn" value="N" style="width: 15px; height: 15px;"/><label style="font-size: medium;" for="radio2N"> 동의하지 않음(작성종료)</label>
					</div><br>
					...
					<div style="text-align: center;">
						<input type="text" id="radioYear" name="radioYear" style="width: 60px;" maxlength="4" oninput="this.value = this.value.replace(/[^0-9]/g, '');"><font style="font-size: medium;">년</font>
						<input type="text" id="radioMonth" name="radioMonth" style="width: 30px;" maxlength="2" oninput="this.value = this.value.replace(/[^0-9]/g, '');"><font style="font-size: medium;">월</font>
						<input type="text" id="radioDay" name="radioDay" style="width: 30px;" maxlength="2" oninput="this.value = this.value.replace(/[^0-9]/g, '');"><font style="font-size: medium;">일</font><br>
						<font style="font-size: medium;">양승민</font>
						<input type="text" name="identify1" style="width: 130px;" maxlength="10" onlyKorean oninput="this.value = this.value.replace(/[^ㄱ-힣]/, '');"><font style="font-size: medium;">(확인 또는 서명)</font><br>
						<font style="font-size: medium;">YSM</font>
						<input type="text" name="identify2" style="width: 130px;" maxlength="10" onlyKorean oninput="this.value = this.value.replace(/[^ㄱ-힣]/, '');"><font style="font-size: medium;">(확인 또는 서명)</font>
					</div><br>
